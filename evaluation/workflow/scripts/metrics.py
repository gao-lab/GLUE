...
r"""
Compute integration metrics for paired samples
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to run info file (.yaml)"
    )
    parser.add_argument(
...
def main(args: argparse.Namespace) -> None:
    ...
    datasets = [anndata.read_h5ad(item, backed="r") for item in args.datasets]
    ...
    with args.run_info.open("r") as f:
