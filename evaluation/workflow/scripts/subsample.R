...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = mean_average_precision,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = seurat_alignment_score,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = avg_silhouette_width,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = avg_silhouette_width_batch,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = neighbor_conservation,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = graph_connectivity,
...
gp <- ggplot(data = df_summarise, mapping = aes(
    x = subsample_size, y = feature_consistency,
